...
//	}
	...
	public void get() {
		...
		TipoNivel tipo = alunoDAO.getById(49).getCurso().getNivel();
		emprestimo.setFuncionario(funcDAO.getById(30));
		emprestimo.setAluno(alunoDAO.getById(49));
		emprestimo.setItem(itemDAO.getById(35));
		emprestimo.setDataCadastrado(BibliotecaDateTime.getDataCadastrado());
		emprestimo.setDataDevolucao(BibliotecaDateTime.getDataDevolucao(tipo));
